...
ALTER TABLE alimentos_usuario ADD COLUMN proteinas_per_unit DECIMAL(5, 1);
ALTER TABLE alimentos_usuario ADD COLUMN grasas_per_unit DECIMAL(5, 1);
ALTER TABLE alimentos_usuario ADD COLUMN carbohidratos_per_unit DECIMAL(5, 1);
ALTER TABLE alimentos_usuario ADD COLUMN kcal_per_unit DECIMAL(7, 1);
...
ALTER TABLE alimentos_global ADD COLUMN proteinas_per_unit DECIMAL(5, 1);
ALTER TABLE alimentos_global ADD COLUMN grasas_per_unit DECIMAL(5, 1);
ALTER TABLE alimentos_global ADD COLUMN carbohidratos_per_unit DECIMAL(5, 1);
ALTER TABLE alimentos_global ADD COLUMN kcal_per_unit DECIMAL(7, 1);
